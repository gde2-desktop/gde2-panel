...
static void applet_change_orient(Gde2PanelApplet* applet, Gde2PanelAppletOrient orient, ShowDesktopData* sdd)
{
...
static void show_desktop_applet_realized(Gde2PanelApplet* applet, gpointer data)
{
	ShowDesktopData* sdd;
	GdkScreen* screen;
...
gboolean show_desktop_applet_fill(Gde2PanelApplet* applet)
{
	ShowDesktopData* sdd;
	...
	sdd->size = gde2_panel_applet_get_size(GDE2_PANEL_APPLET(sdd->applet));
	...
	gde2_panel_applet_set_background_widget(GDE2_PANEL_APPLET (sdd->applet), GTK_WIDGET(sdd->applet));
	...
	gde2_panel_applet_setup_menu_from_file(GDE2_PANEL_APPLET(sdd->applet), ui_path, action_group);
	g_free(ui_path);
...
static void display_help_dialog(GtkAction* action, ShowDesktopData* sdd)
{
	wncklet_display_help(sdd->applet, "gde2-user-guide", "gospanel-564", SHOW_DESKTOP_ICON);
}
...
static void display_about_dialog(GtkAction* action, ShowDesktopData* sdd)
{
	...
	gde2_show_about_dialog(GTK_WINDOW(sdd->applet),

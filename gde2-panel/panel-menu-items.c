...
panel_place_menu_item_create_menu (PanelPlaceMenuItem *place_item)
{
	...
	if (panel_is_program_in_path ("gde2-search-tool"))
...
panel_place_menu_item_recreate_menu (GtkWidget *widget)
{
	...
	if (place_item->priv->menu) {
		...
		gde2_panel_applet_menu_set_recurse (GTK_MENU (place_item->priv->menu),
					       "menu_panel",
				     ...
				     gpointer   data)
{
	...
	panel_menu_items_append_from_desktop (menu, "gde2-user-guide.desktop", NULL, FALSE);

	panel_menu_items_append_from_desktop (menu, "gde2-about.desktop", NULL, FALSE);
...
panel_desktop_menu_item_create_menu (PanelDesktopMenuItem *desktop_item)
{
	...
	desktop_menu = create_applications_menu ("gde2-settings.menu", NULL, FALSE);
...
panel_desktop_menu_item_recreate_menu (PanelDesktopMenuItem *desktop_item)
{
	if (desktop_item->priv->menu) {
		...
		gde2_panel_applet_menu_set_recurse (GTK_MENU (desktop_item->priv->menu),
					       "menu_panel",

			      ...
			      gpointer data)
{
	panel_show_help (gtk_widget_get_screen (w),
			 "gde2-user-guide", "gospanel-1", NULL);
}
...
panel_context_menu_show_about_dialog (GtkWidget *menuitem)
{
	 ...
	 * dialog */
	about = gde2_about_dialog_new ();
	g_object_set (about,
		      "program-name",  _("The GDE2 Panel"),
		      "version", VERSION,
...
panel_context_menu_create (PanelWidget *panel)
{
	...
	gtk_widget_set_name (retval, "gde2-panel-context-menu");

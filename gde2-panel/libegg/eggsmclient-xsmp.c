 ...
 * 2001 Havoc Pennington, Gde2Client (C) 1998 Carsten Schaar, and twm
			    ...
			    gboolean             request_confirmation)
{
   ...
   * the user chooses to save the session. But gde2-session will do
 ...
 * tripping over old apps that use Gde2Client or that use libSM
 * directly.
 */

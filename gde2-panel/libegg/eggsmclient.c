...
egg_sm_client_get_option_group (void)
{
  const GOptionEntry entries[] = {
    ...
    /* Gde2Client compatibility option */
    { "sm-disable", 0, G_OPTION_FLAG_HIDDEN,
      G_OPTION_ARG_NONE, &sm_client_disable,
      NULL, NULL },
    /* Gde2Client compatibility option. This is a dummy option that only
     * exists so that sessions saved by apps with Gde2Client can be restored
